...
>
	...
	<nav class="multi-org-sidebar-nav">
		<a href="{base}/organisations" class="multi-org-sidebar-item" class:active={isDashboard} title="Organisations">
		...
		<a href="{base}/hub-super-admins" class="multi-org-sidebar-item" class:active={isHubSuperAdmins} title="Users">
			<svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
				<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
			</svg>
			{#if !collapsed}<span class="multi-org-sidebar-label">Users</span>{/if}
		</a>
		<a href="{base}/plans" class="multi-org-sidebar-item" class:active={isPlans} title="Plans">
			<svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
				<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
			</svg>
			{#if !collapsed}<span class="multi-org-sidebar-label">Plans</span>{/if}
		</a>
		<a href="{base}/billing" class="multi-org-sidebar-item" class:active={isBilling} title="Billing">
			<svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
		...
		<a href="{base}/marketing" class="multi-org-sidebar-item" class:active={isMarketing} title="Marketing">
			<svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
		...
		{/if}
		<a href="{base}/settings" class="multi-org-sidebar-item" class:active={isSettings} title="Settings">
			<svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
	...
	<div class="multi-org-sidebar-bottom">
		<a href="{base}/auth/logout" class="multi-org-sidebar-item multi-org-sidebar-logout" title="Log out">
			<svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
