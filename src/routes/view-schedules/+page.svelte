					...
					{#if userRotas.length === 0}
						<div class="rounded-xl bg-amber-50 border-2 border-amber-200 p-6" role="status">
							...
							<p class="mt-4 text-lg">
								<a href="/signup/schedules" class="font-semibold text-blue-600 hover:text-blue-800 underline">Sign up for rotas here</a> if you'd like to volunteer.
							</p>
						</div>
					{:else}
						...
						<p class="mt-6 text-lg text-slate-600">
							Want to do more? <a href="/signup/schedules" class="font-semibold text-blue-600 hover:text-blue-800 underline">Sign up for more rotas</a>.
						</p>
					{/if}
				</div>
			{/if}
