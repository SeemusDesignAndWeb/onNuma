	...
	{:else}
		<form method="POST" action="?/update" use:enhance={handleEnhance}>
			...
			<div class="my-info-box">
				...
				<p>
					If you unsubscribe from newsletters, you'll still receive essential rota reminders so you know when you're scheduled. To change your email address, visit <a href="/my/profile" class="my-link">My details</a>.
				</p>
			</div>
