<script>
	...
	function onUploadPdfClick() {
		notifications.info('You can upload PDFs after creating the rota.');
	}
...
<div class="bg-white shadow rounded-lg p-6">
	<div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
		...
		<div class="flex flex-wrap gap-2">
			<a href="/hub/rotas" class="bg-theme-button-3 text-white px-3 py-2 rounded-md hover:opacity-90 text-sm font-medium">
				Cancel
			</a>
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
			...
			<div class="border border-gray-200 rounded-lg p-6 shadow-sm">
				...
				<div class="space-y-4">
					...
					<div>
						<label for="role" class="block text-sm font-medium text-gray-700 mb-1">Rota name <span class="text-hub-red-500">*</span></label>
						...
						<p class="mt-1 text-xs text-gray-500">The name of the rota (e.g. 'Worship Team', 'Welcome Team')</p>
					</div>
					<div>
						...
						<p class="mt-1 text-xs text-gray-500">The number of people needed for this rota</p>
					</div>
			...
			<div class="border border-gray-200 rounded-lg p-6 shadow-sm">
				...
				<p class="text-sm text-gray-600 mb-2">Add documents or links that people can download when signing up for this rota.</p>
