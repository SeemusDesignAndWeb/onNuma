...
<div class="space-y-6">
	...
	<div class="bg-white shadow rounded-lg p-6">
		<div class="flex justify-between items-center">
			<h2 class="text-2xl font-bold text-gray-900">Bulk Schedule Assignment</h2>
			<a
				href="/hub/schedules"
		...
		<p class="mt-2 text-sm text-gray-600">
			Automatically assign contacts to schedules based on flexible monthly frequency and timing criteria.
		</p>
	</div>
	...
	<div class="bg-white shadow rounded-lg p-6">
		...
		<div class="space-y-4">
			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
				...
				<div>
					<label class="block text-sm font-medium text-gray-700 mb-1">Schedule <span class="text-hub-red-500">*</span></label>
					<select 
