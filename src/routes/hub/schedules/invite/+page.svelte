<script>
	...
	async function sendInvites() {
		...
		try {
			const response = await fetch('/hub/schedules/invite/send', {
				method: 'POST',
...
<div class="space-y-6">
	...
	<div class="bg-white shadow rounded-lg p-6">
		<div class="flex justify-between items-center">
			<h2 class="text-2xl font-bold text-gray-900">Bulk Schedule Invitations</h2>
	...
	<div class="bg-white shadow rounded-lg p-6">
		...
		<div>
			...
			<p class="text-xs text-gray-500 mb-2">The email will start with "Hi {'{{firstname}}'}," followed by your message below, then the list of schedules.</p>
			<textarea
	...
	<div class="bg-white shadow rounded-lg p-6">
		<div class="flex justify-between items-center mb-4">
			<h3 class="text-lg font-semibold text-gray-900">Schedules <span class="text-hub-red-500">*</span></h3>
