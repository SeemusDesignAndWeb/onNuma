...
<div class="bg-white shadow rounded-lg p-6">
	...
	{#if step === 'upload'}
		<form method="POST" action="?/upload" use:enhance enctype="multipart/form-data">
			...
			<a href="/hub/contacts" class="ml-2 bg-gray-600 text-white px-2.5 py-1.5 rounded-md hover:bg-gray-700 inline-block">
				Cancel
			</a>
		</form>
	...
	{#if step === 'complete' && importResults}
		...
		<div class="flex gap-2">
			<a href="/hub/contacts" class="bg-hub-green-600 text-white px-2.5 py-1.5 rounded-md hover:bg-hub-green-700">
				View Contacts
			</a>
			<button
				type="button"
